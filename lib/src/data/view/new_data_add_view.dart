...
class NewDataAddView extends StatefulWidget {
  NewDataAddView({super.key, this.isFromCenter = false});

  bool isFromCenter;

  @override
  State<NewDataAddView> createState() => _NewDataAddViewState();
}

class _NewDataAddViewState extends BaseState<NewDataAddView> {
  @override
  void initState() {
    getData();
    super.initState();
  ...
  Widget build(BuildContext context) {
      ...
      return CustomContainer.mainCard(
        ...
        children: [
          ...
          DropDownSearchField<PltaModelData?>(
            ...
            suggestionsCallback: (pattern) async => await p.searchPlta(pattern),
    ...
    Widget detailBaut() {
      return CustomContainer.mainCard(child: Column(
        mainAxisAlignment: MainAxisAlignment.start,
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
