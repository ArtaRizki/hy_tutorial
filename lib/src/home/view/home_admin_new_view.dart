...
class HomeAdminNewView extends StatefulWidget {
  const HomeAdminNewView({super.key});

  @override
  State<HomeAdminNewView> createState() => _HomeAdminNewViewState();
}

class _HomeAdminNewViewState extends BaseState<HomeAdminNewView>
