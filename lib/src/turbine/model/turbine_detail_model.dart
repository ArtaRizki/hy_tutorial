...
TurbineDetailModel turbineCreateModelFromJson(String str) =>
    TurbineDetailModel.fromJson(json.decode(str));

String? turbineCreateModelToJson(TurbineDetailModel data) =>
...
class TurbineDetailModel {
  ...
  factory TurbineDetailModel.fromJson(Map<String, dynamic> json) =>
      TurbineDetailModel(
