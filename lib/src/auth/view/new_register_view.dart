...
class NewRegisterView extends StatefulWidget {
  ...
  @override
  State<NewRegisterView> createState() => NewRegisterViewState();
}

class NewRegisterViewState extends State<NewRegisterView> {
  @override
  void initState() {
    ...
    authP.newRegisterViewState = this;
    super.initState();
  }
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  SizedBox(width: 5),
                  InkWell(
                    onTap: () => CusNav.nPush(context, NewLoginView()),
                    child: Text(
                      "Masuk",
                      style: TextStyle(
                        color: Constant.redisignColor,
