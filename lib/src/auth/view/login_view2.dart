...
import 'package:hy_tutorial/src/auth/bloc/auth_bloc.dart';
...
class LoginView2State extends BaseState<LoginView2> {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomTextField.borderTextField(
                            ...
                            controller: _authRepo.usernameC,
                            fillColor: Colors.white,
                            hintColor: Constant.grayColor.withOpacity(0.5),
                            hintText: "Masukkan username",
                            onChanged: (v) {
                              // state.copyWith(username: v);
                              context
                                  .read<AuthBloc>()
                                  .add(AuthUsernameChanged(v));
                              setState(() {});
                            },
                            labelFontSize: 20,
                          ...
                          CustomTextField.borderTextField(
                            borderRadius: BorderRadius.circular(5),
                            controller: _authRepo.passC,
                            fillColor: Colors.white,
                            hintColor: Constant.grayColor.withOpacity(0.5),
                            hintText: "Ketik kata sandi",
                            onChanged: (v) {
                              // state.copyWith(password: v);
                              context
                                  .read<AuthBloc>()
