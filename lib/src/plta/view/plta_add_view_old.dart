...
class PltaAddViewOld extends StatefulWidget {
  PltaAddViewOld({super.key, this.data});
  PltaDetailModel? data;

  @override
  State<PltaAddViewOld> createState() => PltaAddViewOldState();
}

class PltaAddViewOldState extends BaseState<PltaAddViewOld> {
  @override
  void initState() {
    setData();
    super.initState();
